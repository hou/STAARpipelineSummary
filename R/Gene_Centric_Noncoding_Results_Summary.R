...
#' @param output_prefix the prefix for the output files of the summary of gene-centric noncoding analysis results for protein-coding genes.
...
Gene_Centric_Noncoding_Results_Summary <- function(agds_dir,
  ...
  {
    print(kk)
    results_noncoding <- get(load(file.path(input_path,glue::glue("{gene_centric_results_name}_{kk}.Rdata"))))
  ...
  # UTR
  save(results_UTR_genome,file=file.path(output_path,glue::glue("{output_prefix}_UTR.Rdata")))
  # upstream
  save(results_upstream_genome,file=file.path(output_path,glue::glue("{output_prefix}_upstream.Rdata")))
  # downstream
  save(results_downstream_genome,file=file.path(output_path,glue::glue("{output_prefix}_downstream.Rdata")))
  # promoter CAGE
  save(results_promoter_CAGE_genome,file=file.path(output_path,glue::glue("{output_prefix}_promoter_CAGE.Rdata")))
  # promoter DHS
  save(results_promoter_DHS_genome,file=file.path(output_path,glue::glue("{output_prefix}_promoter_DHS.Rdata")))
  # enhancer CAGE
  save(results_enhancer_CAGE_genome,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_CAGE.Rdata")))
  # enahncer DHS
  save(results_enhancer_DHS_genome,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_DHS.Rdata")))
  ...
  {
    print(kk)
    results_ncRNA <- get(load(file.path(ncRNA_input_path,glue::glue("{ncRNA_results_name}_{kk}.Rdata"))))
    results_ncRNA_genome <- rbind(results_ncRNA_genome,results_ncRNA)
    
  }
  
  save(results_ncRNA_genome,file=file.path(ncRNA_output_path,glue::glue("{output_prefix}_results_ncRNA_genome.Rdata")))
  
  
  ###### significant results
  ### UTR
  UTR_sig <- results_UTR_genome[results_UTR_genome[,"STAAR-O"]<alpha,,drop=FALSE]
  write.csv(UTR_sig,file=file.path(output_path,glue::glue("{output_prefix}_UTR_sig.csv")))
  ...
  write.csv(upstream_sig,file=file.path(output_path,glue::glue("{output_prefix}_upstream_sig.csv")))
  ...
  write.csv(downstream_sig,file=file.path(output_path,glue::glue("{output_prefix}_downstream_sig.csv")))
  ...
  write.csv(promoter_CAGE_sig,file=file.path(output_path,glue::glue("{output_prefix}_promoter_CAGE_sig.csv")))
  ...
  write.csv(promoter_DHS_sig,file=file.path(output_path,glue::glue("{output_prefix}_promoter_DHS_sig.csv")))
  ...
  write.csv(enhancer_CAGE_sig,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_CAGE_sig.csv")))
  ...
  write.csv(enhancer_DHS_sig,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_DHS_sig.csv")))
  ...
  write.csv(ncRNA_sig,file=file.path(ncRNA_output_path,glue::glue("{output_prefix}_ncRNA_sig.csv")))
  
  noncoding_sig <- rbind(noncoding_sig,ncRNA_sig)
  
  write.csv(noncoding_sig,file=file.path(output_path,glue::glue("{output_prefix}_noncoding_sig.csv")))
  ...
  if(length(known_loci)!=0)
  {
    ...
    write.csv(UTR_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_UTR_sig_cond.csv")))
    ...
    write.csv(upstream_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_upstream_sig_cond.csv")))
    ...
    write.csv(downstream_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_downstream_sig_cond.csv")))
    ...
    write.csv(promoter_CAGE_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_promoter_CAGE_sig_cond.csv")))
    ...
    write.csv(promoter_DHS_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_promoter_DHS_sig_cond.csv")))
    ...
    write.csv(enhancer_CAGE_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_CAGE_sig_cond.csv")))
    ...
    write.csv(enhancer_DHS_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_enhancer_DHS_sig_cond.csv")))
    ...
    write.csv(ncRNA_sig_cond,file=file.path(ncRNA_output_path,glue::glue("{output_prefix}_ncRNA_sig_cond.csv")))
    noncoding_sig_cond <- rbind(noncoding_sig_cond,ncRNA_sig_cond)
    
    ## noncoding
    write.csv(noncoding_sig_cond,file=file.path(output_path,glue::glue("{output_prefix}_noncoding_sig_cond.csv")))
  }
  ...
  if(manhattan_plot)
  {
    ...
    png(file.path(output_path,glue::glue("{output_prefix}_gene_centric_noncoding_manhattan.png")), width = 9, height = 6, units = 'in', res = 600)
  ...
  if(QQ_plot)
  {
    ...
    png(file.path(output_path,glue::glue("{output_prefix}_gene_centric_noncoding_qqplot.png")), width = 9, height = 9, units = 'in', res = 600)
